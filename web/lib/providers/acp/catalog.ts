...
export const ACP_AGENTS: AcpAgentCatalogEntry[] = [
  ...
  { id: 'claude-agent', label: 'Claude Code', sourceUrl: 'https://docs.anthropic.com/en/docs/claude-code/model-config', adapterUrl: 'https://www.npmjs.com/package/@agentclientprotocol/claude-agent-acp', authMode: 'web', modelSelection: CLAUDE_CODE_MODEL_SELECTION, note: 'Via pinned Agent Client Protocol adapter.' },
  { id: 'cline', label: 'Cline', sourceUrl: 'https://cline.bot/', authMode: 'web' },
  { id: 'codex-cli', label: 'Codex CLI', sourceUrl: 'https://developers.openai.com/codex/cli', adapterUrl: 'https://www.npmjs.com/package/@agentclientprotocol/codex-acp', authMode: 'web', modelSelection: CODEX_CLI_MODEL_SELECTION, note: 'Via pinned Agent Client Protocol adapter.' },
