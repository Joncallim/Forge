CREATE TABLE "forge_epic_172_enablement_state" (
	...
	CONSTRAINT "forge_epic_172_enablement_sha_chk" CHECK ("forge_epic_172_enablement_state"."reviewed_sha" is null or "forge_epic_172_enablement_state"."reviewed_sha" ~ '^([0-9a-f]{40}|[0-9a-f]{64})$'),
...
CREATE TABLE "forge_epic_172_release_evidence" (
	...
	CONSTRAINT "forge_epic_172_release_evidence_sha_chk" CHECK ("forge_epic_172_release_evidence"."reviewed_sha" ~ '^([0-9a-f]{40}|[0-9a-f]{64})$'),
...
CREATE TABLE "forge_epic_172_transition_authorizations" (
	...
	CONSTRAINT "forge_epic_172_transition_authorizations_sha_chk" CHECK ("forge_epic_172_transition_authorizations"."reviewed_sha" ~ '^([0-9a-f]{40}|[0-9a-f]{64})$'),
