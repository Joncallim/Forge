...
# commits. Migrations 0034, 0035, and 0036 are separate protected stages and
# therefore must each receive a fresh handoff rather than attempting to reuse a
# previous stage's authority. Each stage is independently failure-safe and the
# EXIT trap cleans up any handoff left open by an interrupted or failed stage.
stage_active=0
...
run_stage npx tsx scripts/ci/migrate-through-0036.ts
