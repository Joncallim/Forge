...
# Reconciliation has completed, so the missing-index refusal must happen before
# any concurrent DDL. This proves cutover itself is the boundary, not the builder.
